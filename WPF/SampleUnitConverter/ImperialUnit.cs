...
namespace SampleUnitConverter {
    internal class ImperialUnit : DistanceUnit{
        private static List<ImperialUnit> units = new List<ImperialUnit> {
            new ImperialUnit{Name = "in", Coeffcient = 1,},
            new ImperialUnit{Name = "ft", Coeffcient = 12,},
            new ImperialUnit{Name = "yd", Coeffcient = 12 * 3,},
            new ImperialUnit{Name = "ml", Coeffcient = 12 * 3 * 1760,},
        };
