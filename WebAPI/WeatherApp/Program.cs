...
namespace WeatherApp {
    ...
    private const string Url =
        "https://api.open-meteo.com/v1/forecast?latitude=79.0&longitude=-52.0&current=temperature_2m,wind_speed_10m.relative_humidity_2m";
        ...
        static async Task Main(string[] args) {
            ...
            try {
                ...
                if (weather?.current != null) {
                    ...
                    Console.WriteLine($"温度：{weather.current.relative_humidity_2m}％");
                } else {
